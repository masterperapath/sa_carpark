        ...
        $.ajax({
                    ...
                    success : function(response) {
                        ...
                        $.each(record, function (i, item) {             
                        	    ...
                        	    table += '<td>'+ item.b_overdue_fees   + '<br>' + "/" + item.enabled + '</td><td>' + item.b_hide_from_dlt + '</td><td>' + item.c_plate_number + '<br>' + "/" + item.c_car_code + '<br>' + "/" + item.c_car_type + '<br>' + "/" + item.c_driver_name + '<br>' + "/" + item.c_mobile_num + '</td>'
                        	     	  + '<td>' + item.c_comment + '</td><td>' + item.c_group_name + '</td><td>' + item.ts_gprsdate + '</td><td>' + item.ts_keepalive + '</td><td>' + item.i_ext_power_voltage + 'V' + '</td>'
                        	     	  + '<td>' + item.i_speed +'</td><td>' + item.position + '</td><td>' + item.c_box_note + '</td><td>' + item.dt_install + '<br>' + "/" + item.c_technician + '</td><td>' + item.c_user_vin + '</td><td>' + item.i_card + '</td></tr>';
                        });
